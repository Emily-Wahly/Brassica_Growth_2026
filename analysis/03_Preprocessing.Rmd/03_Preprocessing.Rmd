...
<span style="font-weight: bold;">I've removed anything below 1200 reads. I now have `r num_samples`. The paper had 126. # samples does not change when I filter by 1000 instead.  </span>
...
```
We now have a preprocessed phyloseq object with 122 ASVs and a sequencing depth of 1200. The figures show the justification for filtering at this level. With these ASVs we will be able to identify the most common taxa on the Brassica phyllosphere.
